...
import AdmQueries from './admqueries';
    ...
    <div>
      ...
      <List>
          ...
          <ListItem button selected={selectedIndex === 1} onClick={event => handleListItemClick(event, 1)}>
            ...
            <ListItemText primary='Вопросы клиентов' />
          </ListItem>
          ...
          <ListItem button selected={selectedIndex === 3} onClick={event => handleListItemClick(event, 3)}>
            ...
            <ListItemText primary='Запросы клиентов' />
          </ListItem>
  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        {selectedIndex === 1 && <Questions/>}
        {selectedIndex === 2 && <Callbacks/>}
        {selectedIndex === 3 && <AdmQueries/>}

        {selectedIndex === 4 && <Users/>}
